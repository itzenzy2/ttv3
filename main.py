...
twitch_miner = TwitchChannelPointsMiner(
    username="enzzyplays",
    password="akash2005@@@@@",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1251658564641226782/G30Soun13_z_q6F15TMgBvEH2ZpFgaMbRFDXtU15YPKWIZalpSkyNBXZi_x0fViF4ztf",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.BET_LOSE, Events.CHAT_MENTION, Events.GAIN_FOR_RAID, Events.GAIN_FOR_CLAIM, Events.GAIN_FOR_WATCH, Events.GAIN_FOR_WATCH_STREAK],                                  # Only these events will be sent to the chat
        ),
        webhook=Webhook(
